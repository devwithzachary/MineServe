...
# MineServe Linux-Environment Release Build Script (for macOS & Linux)
...
echo "============================================================"
echo "🐧 MineServe Reproducible Linux Release Build"
echo "============================================================"
...
FDROID_APP_ID="com.devwithzachary.mineserve"
...
AAB_TARGET="$OUT_DIR/MineServe-${VERSION_NAME}-playstore.aab"
APK_TARGET="$OUT_DIR/MineServe-${VERSION_NAME}-release.apk"
