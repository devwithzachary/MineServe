...
Java_com_devwithzachary_mineserve_engine_PtyNative_createSubprocess(
    JNIEnv *env,
    jobject thiz,
    jstring cmdPath,
    jobjectArray jArgs,
...
Java_com_devwithzachary_mineserve_engine_PtyNative_setPtyWindowSize(
    JNIEnv *env,
    jobject thiz,
    jint masterFd,
    jint cols,
...
JNIEXPORT void JNICALL
Java_com_devwithzachary_mineserve_engine_PtyNative_closeFd(
    JNIEnv *env,
    jobject thiz,
    jint masterFd) {
    if (masterFd >= 0) {
...
JNIEXPORT jint JNICALL
Java_com_devwithzachary_mineserve_engine_PtyNative_waitForProcess(
    JNIEnv *env,
    jobject thiz,
    jint pid) {
    int status = 0;
